...
class Message(models.Model):
    ...
    """
    subject = encrypt(models.CharField(_("Subject"), max_length=100))
    body = encrypt(models.TextField(_("Body"), max_length=1400))
    ...
    sent_at = models.DateTimeField(_("sent at"), null=True,
                                           blank=True)
    read_at = models.DateTimeField(_("read at"), null=True,
                                           blank=True)
...
if "pinax.notifications" not in settings.INSTALLED_APPS and getattr(
