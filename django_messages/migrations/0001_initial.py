    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject', django_cryptography.fields.encrypt(models.CharField(max_length=100, verbose_name='Subject'))),
                ('body', django_cryptography.fields.encrypt(models.TextField(max_length=1400, verbose_name='Body'))),
