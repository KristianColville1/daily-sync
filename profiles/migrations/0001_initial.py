    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', cloudinary.models.CloudinaryField(default='/static/img/default-profile-image.png', max_length=255, verbose_name='avatar')),
                ('background', cloudinary.models.CloudinaryField(default='/static/img/default_backgrounds/bg.webp', max_length=255, verbose_name='background')),
